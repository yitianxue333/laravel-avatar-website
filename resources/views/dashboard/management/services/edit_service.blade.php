...
<div class="col-md-12">
    <div class="ibox">
        <div class="ibox-title">
            <h2 class="headingTwo">Service</h2>
        </div>
        <div class="ibox-content">
            <div class="row">
                <div class="col-md-12">
                    <p class="paragraph">Add and update your services to stay organized when creating quotes, jobs, and invoices.</p>
                ...
                <div class="col-md-12 jobTypePanel" id="service_table">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h3 class="headingTwo">Service Info</h3>
                        </div>
