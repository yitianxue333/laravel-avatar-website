		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            ...
		            <div class="email-btn-wrapper">
		                <a type="button" href="{{url('clienthub')}}/{{$user->id}}/quotes/{{$quote->quote_id}}" class="btn btn-lg btn-job u-grid10 u-textBold u-textNormal" target="_blank">Review & Approve</a>
		            </div>
		        </div>
		    </div>
		</div>
