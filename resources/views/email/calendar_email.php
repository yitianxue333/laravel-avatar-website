		        ...
		        <div class="modal-content">
		            ...
		            <div class="modal-body">
		                <div class="row nopadding">
		                    <div class="col-md-12">
		                        <h3 class="paragraph">Hello,{{to}}</h3>
		                    ...
		                    <div class="col-md-12">
		                    	<ul class="nopadding" style="list-style-type: none;padding: 0;">
		                    		...
		                    		<li>
		                    			...
		                    			<div class="col-md-9">{{$user->description}}</div>
		                    		</li>
		                    		<li>
		                    			<div class="col-md-3">Start Date</div>
		                    			<div class="col-md-9">{{$user->date_started}}</div>
		                    		</li>
		                    		<li>
		                    			<div class="col-md-3">End Date</div>
		                    			<div class="col-md-9">{{$user->date_ended}}</div>
		                    		</li>
		                    		<li>
		                    			<div class="col-md-3">Start time</div>
		                    			<div class="col-md-9">{{$user->time_started}}</div>
		                    		</li>
		                    		<li>
		                    			<div class="col-md-3">End time</div>
		                    			<div class="col-md-9">{{$user->time_ended}}</div>
		                    		</li>
